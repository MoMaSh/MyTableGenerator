...
import org.vaadin.jpatablegenerator.annotations.MyTable;
import org.vaadin.jpatablegenerator.common.MyUtil;
import org.vaadin.jpatablegenerator.components.MyEdit;
import org.vaadin.jpatablegenerator.components.MyImport;
import org.vaadin.jpatablegenerator.layout.GeneratedEdit;
import org.vaadin.jpatablegenerator.table.MyColumn;
	...
	public GenerateTableInfo(Class<?> clazz, boolean shallGenerate, boolean includeId) {
		...
		if (shallGenerate) {
			...
			for (Field f : clazz.getDeclaredFields()) {
				org.vaadin.jpatablegenerator.annotations.MyColumn myColumn = f.getAnnotation(org.vaadin.jpatablegenerator.annotations.MyColumn.class);
				if (myColumn != null) {
