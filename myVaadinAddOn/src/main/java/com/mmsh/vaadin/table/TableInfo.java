...
public abstract class TableInfo implements Serializable {
	...
	/** The popup resizable. */
	private boolean popupResizable = false;
	 ...
	 *            The new popup width
	 */
	public final void setPopupWidth(final int pPopupWidth) {
		this.popupWidth = pPopupWidth;
	}
	 ...
	 */
	public final void setPopupHeight(final int pPopupHeight) {
		this.popupHeight = pPopupHeight;
	}
	 ...
	 */
	public final String getPopupCaption() {
		return popupCaption;
	}
	 ...
	 */
	public final void setPopupCaption(final String pPopupCaption) {
		this.popupCaption = pPopupCaption;
	}
	...
	/**
	 * Checks if is the window that is popped up is resizable or not.
	 * 
	 * @return the popup resizable
	 */
	public final boolean isPopupResizable() {
		return popupResizable;
	}

	/**
	 * Sets the popup resizable. Makes the popped-up window resizable.
	 * 
	 * @param pPopupResizable
	 *            the new popup resizable
	 */
	public final void setPopupResizable(final boolean pPopupResizable) {
		this.popupResizable = pPopupResizable;
	}
