...
import com.mmsh.vaadin.layout.ListPopupLayout;
import com.mmsh.vaadin.table.MyTable;
...
public class ListPopupWindow extends Window {
	...
	private void generalSettings(final TableInfo tableInfo) {
		...
		setWidth(tableInfo.getPopupWidth(), Unit.PIXELS);
		setHeight(tableInfo.getPopupHeight(), Unit.PIXELS);
	}
}
