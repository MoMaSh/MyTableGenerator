...
import org.mmsh.vaadin.common.MyTable;
...
import org.mmsh.vaadin.table.MyColumn;
	...
	public GenerateTableInfo(Class<?> clazz, boolean shallGenerate, boolean includeId) {
		...
		if (shallGenerate) {
			...
			for (Field f : clazz.getDeclaredFields()) {
				org.mmsh.vaadin.common.MyColumn myColumn = f.getAnnotation(org.mmsh.vaadin.common.MyColumn.class);
				if (myColumn != null) {
